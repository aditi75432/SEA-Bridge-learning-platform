...
//       examples: []
//     }
//   }, updateProfile } = useCulturalContext()
...
//     if (["formalityPreference", "visualStyle", "region", "ageGroup", "country"].includes(field)) {
...
//                       <select
//                         id="formality"
//                         value={formData.formalityPreference}
//                         onChange={(e) => handleChange("formalityPreference", e.target.value)}
//                         className="w-full p-2 border rounded-lg bg-white"
//                       >
...
//                         {profile.culturalElements.examples.slice(0, 3).map((example, index) => (
...
//                             <div className="w-full h-20 bg-gradient-to-br from-primary-50 to-sky-50 rounded mb-2"></div>
